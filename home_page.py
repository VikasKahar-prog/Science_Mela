...
class HomePage(ctk.CTk):
    def __init__(self):
        ...
        # self.bgimage = ctk.CTkImage(dark_image=Image.open(r"C://Users//vikas//Downloads//keith-misner-h0Vxgz5tyXA-unsplash.jpg"),size=(self.width, self.height))
        # self.bglabel = ctk.CTkLabel(self.container_frame,image = self.bgimage,text = "")
